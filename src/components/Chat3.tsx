...
return (
        ...
        <div className='h-[85vh]  flex flex-col overflow-auto text-white'>
          {messag.length === 0 ?(
            <div className='flex mt-55 self-center'>No Messages</div>
             ...
             messag.map((msg: any) => (
              <div style={{
                backgroundColor:msg.senderId == sender ? "green" : "grey"
              }} key={msg._id + Math.random()} className='text-white my-1 ' style={{ display: 'flex', justifyContent: msg.senderId === sender ? "end" : "start" }}>
   ...
   <div className=' w-[100vw] border text-white block md:hidden bg-black h-[100vh]'>
        ...
        <div className='py-[5vh] h-[100vh] overflow-auto flex flex-col text-white'>
          { loading ? (
